...
class CommunitiesControllerTest < ActionController::TestCase
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post :create, community: { city: @community.city, country: @community.country, pincode: @community.pincode, state: @community.state }
    end
  ...
  test "should update community" do
    patch :update, id: @community, community: { city: @community.city, country: @community.country, pincode: @community.pincode, state: @community.state }
    assert_redirected_to community_path(assigns(:community))
  end
