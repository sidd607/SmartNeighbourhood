...
rails generate scaffold Tag name:string post_id:integer user_id:integer type:integer --force
...
rails generate scaffold Poll user_id:integer post_id:integer options:text user_response:text interim:integer finish_time:timestamp anonimity:integer vote_type:integer community_id:integer restricted_id:integer  --force
